...
import('core.lib.openid.auth.openid.Message');
import('core.lib.openid.auth.openid.HMAC');
import('core.lib.openid.auth.openid.Association');
import('core.lib.openid.auth.openid.CryptUtil');
import('core.lib.openid.auth.openid.DiffieHellman');
import('core.lib.openid.auth.openid.KVForm');
import('core.lib.openid.auth.openid.Nonce');
import('core.lib.openid.auth.openid.Discover');
import('core.lib.openid.auth.openid.URINorm');
import('core.lib.openid.auth.yadis.Manager');
import('core.lib.openid.auth.yadis.XRI');
