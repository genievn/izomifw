 ...
 */
global $abs, $ds;
//echo "{$abs}core{$ds}lib{$ds}openid{$ds}auth{$ds}yadis{$ds}PlainHTTPFetcher.php";
import('core.lib.openid.auth.yadis.PlainHTTPFetcher');
import('core.lib.openid.auth.yadis.ParanoidHTTPFetcher');
